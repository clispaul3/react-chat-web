...
var $W = $(window),
  ...
  DEFAULTS = {
    ...
    icons: {
      ...
      zoomIn: 'iconfont icon-iconset0158',
      zoomOut: 'iconfont icon-icon--1',
      prev: 'iconfont icon-fanhuishangyizhang',
      next: 'iconfont icon-xiayizhang',
      fullscreen: 'fa fa-photo',
      actualSize: 'fa fa-arrows-alt',
      rotateLeft: 'fa fa-rotate-left',
      rotateRight: 'iconfont icon-xiazai1'
    },
